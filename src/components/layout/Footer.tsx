          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Powering enterprise digital transformation with cutting-edge cloud solutions and
                AI-driven infrastructure. Trusted by Fortune 500 companies worldwide for
